	...
	<div>
		...
		<div id="comment">
			...
			<div class="buyer-com">
				...
				<a href="javascript:;" class="num">查看全部138条</a>
			</div>
			<div class="tag">
				购买过该商品的用户认为
			</div>
		...
		<div id="detail-wrap">
			...
			<div class="picList">
				<div class="mb5">
					...
					<div v-for="item1 in pics1" class="pic-div pics1">
						<img :src="item1" />
					</div>
				</div>
				<div class="mb5">
					<div class="name">
						<h2><span>商品参数</span></h2>
					</div>
					<div class="keyList">
						<div v-for="item2 in keyList" class="keyItem">
							<span class="key">{{item2.key}}</span>
