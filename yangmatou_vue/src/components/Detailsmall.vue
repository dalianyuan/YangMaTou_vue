<template>
	<div>
	  ...
	  <!--banner图====================-->
		  ...
		  <!--banner图============结束========-->
		  <!--中间介绍======================-->
		  	<div class="detailTitle"><h2>👏好物推荐🎺夏季必囤【欧缇丽保湿喷雾】</h2></div>
		  	...
		  	<div class="detailSay">
		  		...
		  		<br/>
		  		使用感：水雾很细，很适合空调间里通勤上学随时拿出来喷一喷。开始化妆的时候可以拿出来喷一喷，以免爆皮，或者化妆之后当定妆水来用。总之是一瓶不可或缺的百搭基础款。
		  	</div>
		  	<div class="redFont">
		  		<em>#空瓶记#</em>
		  		<em>#护肤日常#</em>
...
export default {
  ...
  methods :{
  	getText(fid){//形参
  		this.$router.history.push({name: "Detailsmall",params:{fid:fid}})
  	}
  }
}
